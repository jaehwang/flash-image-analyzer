...
class FilesystemAnalyzer:
    ...
    def _analyze_ext_filesystem(self, f: BinaryIO, offset: int, size: int, header: bytes) -> FilesystemInfo:
    ...
    def _analyze_squashfs_filesystem(self, f: BinaryIO, offset: int, size: int, header: bytes) -> FilesystemInfo:
    ...
    def _analyze_ubifs_filesystem(self, f: BinaryIO, offset: int, size: int, header: bytes) -> FilesystemInfo:
    ...
    def _analyze_jffs2_filesystem(self, f: BinaryIO, offset: int, size: int, header: bytes) -> FilesystemInfo:
    ...
    def _analyze_yaffs2_filesystem(self, f: BinaryIO, offset: int, size: int, header: bytes) -> FilesystemInfo:
